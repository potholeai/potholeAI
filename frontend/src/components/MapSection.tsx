      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Issue Map</h2>
              <p className="text-gray-600">Real-time pothole reports across Gurugram</p>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <Layers className="h-5 w-5 text-gray-400" />
            <span className="text-sm text-gray-600">{issues.length} active issues</span>
          </div>
        </div>
      </div>
