      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Help improve Gurugram's roads</p>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-orange-500 dark:hover:border-orange-400 transition-colors">
            ...
            <label htmlFor="photo-upload" className="cursor-pointer">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">PNG, JPG up to 10MB each</p>
            </label>
          </div>
